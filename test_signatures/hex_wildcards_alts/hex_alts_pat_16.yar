rule hex_str_128 {
	...
	$hex_9 = { 48 2b 48 2a ( 5c | 30 | 4a | 2d | 33 | 5e | 53 | 63 ) 25 65 3c 3f }
	$hex_10 = { 55 3a 46 5e ( 68 | 5b | 7a | 59 | 7a | 69 | 59 | 32 ) 28 39 72 77 }
	$hex_11 = { 62 5d 6b 3b ( 76 | 4d | 6a | 72 | 4b | 48 | 30 | 5d ) 40 50 74 78 }
	$hex_12 = { 6d 5c 30 4a ( 59 | 7d | 74 | 23 | 67 | 7d | 46 | 67 ) 2d 33 5e 53 }
	$hex_13 = { 63 68 5b 7a ( 6f | 4c | 7e | 73 | 4f | 64 | 65 | 2c ) 59 7a 69 59 }
	$hex_14 = { 32 76 4d 6a ( 4a | 5f | 5d | 32 | 50 | 58 | 6a | 63 ) 72 4b 48 30 }
	$hex_15 = { 5d 59 7d 74 ( 3e | 23 | 32 | 28 | 21 | 67 | 37 | 49 ) 23 67 7d 46 }
	$hex_16 = { 67 6f 4c 7e ( 71 | 40 | 5e | 50 | 3d | 7c | 5d | 58 ) 73 4f 64 65 }
